 ...
 */
class CommunicatorCorp_Communicator_Block_Adminhtml_System_Config_Form_TestButton extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('communicator/system/config/form/test_button.phtml');
    }
